      ...
      <main className="policies-main-content">
        ...
        <section className="shipping-policy">
          ...
          <p>
            ...
            , we take pride in ensuring that our perfumes reach you as fast as possible.
        ...
        <section className="return-policy">
          ...
          <p>
            ...
            satisfied with your purchase, you may return it within 7 days of
            ...
            shipping costs are not covered by ELIXIR.
          </p>
        </section>
        ...
        <section className="terms-conditions">
          ...
          <p>
            By accessing or using the ELIXIR website and our services, you
        ...
        <section className="sustainability-commitment">
          ...
          <p>
            Sustainability is at the heart of everything we do at ELIXIR.
